...
public protocol RAImagePickerAssetCell : class {
...
/*
        A default implementation of `ImagePickerAssetCell`. If user does not register a custom cell, Image Picker will use this one. Also contains default icon for selected state.
 */
class RAAssetCell : UICollectionViewCell, RAImagePickerAssetCell {
