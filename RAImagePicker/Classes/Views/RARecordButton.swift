...
/*
    RARecordButton: a rounded button with 2 circles where middle circle animates based on 3 states - initial, pressed, recording.
 */
class RARecordButton : RAStationaryButton {
