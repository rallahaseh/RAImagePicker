...
/*
    RARecordDurationLabel: Label that can be used to show duration during recording or just any duration in general.
 */
final class RARecordDurationLabel : UILabel {
    ...
    private func updateLabel() {
        ...
        /*
            DateComponentsFormatter, because it does not pad zero to hours component so it regurns pattern 0:00:00, we need 00:00:00
         */
